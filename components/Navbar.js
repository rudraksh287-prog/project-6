    ...
    <nav>
      <div className="bg-black text-white flex justify-between px-4 items-center h-16">
        ...
        <div className='relative'>
          ...
          {!session &&
            <Link href={"/login"}>
              <button className="text-white bg-gradient-to-r from-purple-500 via-purple-600 to-purple-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-purple-300 dark:focus:ring-purple-800 font-medium rounded-2xl text-sm px-4 py-2.5 text-center leading-5 mx-1">LOgIN</button>
            </Link>
          }
        </div>
      </div>
